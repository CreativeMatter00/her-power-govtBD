      ...
      <section className="border-t-2 border-brandLsPrimary mb-4 ">
        <div className="max-w-7xl container flex flex-col">
          ...
          <div className="mt-7 mb-2 flex flex-col ">
            <h1 className="text-3xl text-brandDs font-normal">{t("Challenges")}</h1>
                ...
                data?.data?.map((blogPost: any, index: number) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center">
                      <Link
                        href={`/${locale}/challenges/challenge/challenge-management/${blogPost?.cpost_pid}`}
                        className="text-link"
                      >
                        {t("View")}
                      </Link>
                      <Link
                        href={`/${locale}/challenges/challenge/challenge-management/edit-challenge/${blogPost?.cpost_pid}`}
                        className="text-link"
                      >
                        {t("Edit")}
                      </Link>
                      <button
                        ...
                        onClick={() => {
                          ...
                          setSelectedItem(blogPost?.cpost_pid);
                        }}
                      >
                        {t("Delete")}
                      </button>
