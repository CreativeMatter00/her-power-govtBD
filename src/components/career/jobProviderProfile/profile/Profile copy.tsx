...
// 									{/* <div className="flex  items-start lg:items-center gap-0 lg:gap-8 text-base text-brandPrimary">
// 										<p>
// 											Total Organized Event:{" "}
// 											<span className="text-brandDs">5</span>
// 										</p>
// 										<p>
// 											Upcoming Event: <span className="text-brandDs">1</span>
// 										</p>
// 									</div> */}
// 								</div>
// 							</div>
