...
const FileInput: React.FC<IFiles> = ({ selectedImages, setSelectedImages }) => {
  ...
  return (
    <>
      <div>
        ...
        <div className="mt-1 block  placeholder:text-[#cacaca] text-base border border-brandLsPrimary rounded w-full h-[390px]">
