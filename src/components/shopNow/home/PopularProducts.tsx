...
import { getPopularProductsHome } from "@/api/api";
...
const PopularProducts = () => {
	...
	const { isLoading, error, data } = useQuery({
		queryKey: ["getPopularProductsHome"],
		queryFn: getPopularProductsHome,
	});
	...
	return (
		<div className="bg-brandLsPrimary border-2 border-brandLsPrimary">
			<div className="container mx-auto my-8 py-10">
				<div className="flex items-center justify-between mb-6">
					...
					<Link href={`/${locale}/shop-now/popular-products`}>
				...
				{isLoading ? (
					...
					>
						...
						<CarouselPrevious className="left-1 bg-brandDs text-white border-none" />
						<CarouselNext className="right-1 bg-brandDs text-white border-none" />
					</Carousel>
				)}
			</div>
		</div>
