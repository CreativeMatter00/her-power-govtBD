...
const cookies = useCookies();
  ...
  // console.log("selectedImageBanner----------------|> ", selectedImageBanner)
  // console.log("selectedImageThumbnail----------------|> ", selectedImageThumbnail)
  ...
  const onSubmit = async (data: IFormInput) => {
    ...
    try {
      ...
      router.push(
        `/${locale}/resource-library/articles/article-management/${id}`
      );
    } catch (error) {
